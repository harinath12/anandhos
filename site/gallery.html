		        		...
		        		<div class="container">
        					<div class="row">
        						<div class="col-lg-4 col-md-6 col-sm-6">
				                    <!--<div class="galbox-1">
			                            <div class="galbox-1-img">
			                                <img src="images/gallery/gal-img.jpg" alt="" class="img-fluid">
			                                <div class="gal-icon-wrap">
			                                   <a href="infrastructure-photos.html" title="View Album"><i class="fa fa-eye"></i></a>
			                                </div>
			                            </div>
			                            <div class="galbox-1-content">
			                               <h3 class="galbox-1-title"><a href="infrastructure-photos.html">Hospital Entrance</a></h3>
			                            </div>
			                        </div>-->
			                        <div class="mygalbox-wrap">
										<div class="mygalbox">
			                                <img src="images/gallery/gal-img.jpg" alt="" class="img-fluid">
			                                <!--<a href="galleryphotos.html"><i class="fab fa-youtube"></i></a>-->
			                            </div>
			                            <div class="mygalbox-title">
			                            	<h5><a href="galleryphotos.html">Infrastructure</a></h5>
			                            </div>
		                            </div>
				                </div>
				                <div class="col-lg-4 col-md-6 col-sm-6">
				                    <div class="mygalbox-wrap">
			                            ...
			                            <div class="mygalbox-title">
			                            	<h5><a href="galleryphotos.html">News &amp; Events</a></h5>
			                            </div>
		                            </div>
				                </div>
				                <div class="col-lg-4 col-md-6 col-sm-6">
				                    <div class="mygalbox-wrap">
			                            ...
			                            <div class="mygalbox-title">
			                            	<h5><a href="galleryphotos.html">Grand Opening</a></h5>
			                            </div>
		                            </div>
				                </div>
        					</div>
